...
class GUI:
    ...
    def __init__(self):
        ...
        # create a 'CONTINUE' button with an action
    ...
    def goAhead(self, name):
        ...
        # the thread for receiving messages does not change
        rcv = threading.Thread(target=self.receive)
        rcv.start()

    # The main layout of the chat
    def layout(self, name):
        # ----------------------------display the chat if you want to modify it--------------------------------
        self.name = name
        # to show chat window
        ...
        # place the scroll bar into the gui chat
